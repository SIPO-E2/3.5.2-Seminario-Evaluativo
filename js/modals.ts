...
export const modal = async (
  ...
  const modalProductLabel = document.getElementById(
    "modalProductLabel"
  ) as HTMLInputElement;
  const productModal = document.getElementById(
    "ProductModal"
  ) as HTMLInputElement;
  const descriptionModal = document.getElementById(
    "DescriptionModal"
  ) as HTMLInputElement;
  ...
  const thumbnailModal = document.getElementById(
    "ThumbnailModal"
  ) as HTMLInputElement;
  const carouselImagesInner = document.getElementById(
    "carouselImagesInner"
  ) as HTMLDivElement;
  const carouselImagesModal = document.getElementById(
    "carouselImagesModal"
  ) as HTMLDivElement;
  const imagesModal = document.getElementById(
    "ImagesModal"
  ) as HTMLInputElement;
  ...
  if (modalID === "ProductModalEdit") {
    ...
    addProductBtn.onclick = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          alert(
            `Failed to update product. Server responded with status: ${response.status}`
          );
        }
      } catch (error) {
    ...
    addProductBtn.onclick = async () => {
      ...
      if (
        ...
        alert(
          "Correct input please fill with correct values in all required fields."
        );
        return;
      }
